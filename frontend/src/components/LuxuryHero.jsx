    ...
    useEffect(() => {
        ...
        const timer = setTimeout(() => {
            const ctx = gsap.context(() => {
                ...
                heroTL.to(bgLayerFarRef.current, {
                    yPercent: -20,
                    scale: 1.05,
                    ease: 'none'
                }, 0);

                heroTL.to(bgLayerMidRef.current, {
                    yPercent: -10,
                    scale: 1.02,
                    opacity: 0.6,
                    ease: 'none'
    ...
    return (
        <section className={`luxury-hero ${isLoaded ? 'loaded' : ''}`} ref={heroRef}>
            ...
            <nav className="luxury-hero__nav">
                <a href="#" className="luxury-hero__logo" onClick={(e) => { e.preventDefault(); onNavigate('home'); }}>
                    ROOMGI
                </a>
            ...
            <div className="luxury-hero__content" ref={contentRef}>
                <div className="luxury-hero__text">
                    ...
                    <div className="luxury-hero__subtitle" ref={subtitleRef}>
                        <p>Welcome to RoomGi - India's trusted platform for buying and selling properties. Browse verified listings, connect with sellers directly, and find your dream home without intermediaries.</p>
                    </div>
                    ...
                    <div className="luxury-hero__actions">
                        ...
                        <button className="btn-luxury-gold" onClick={() => onNavigate('tour')}>
