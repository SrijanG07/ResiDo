        ...
        <div className="luxury-detail">
            ...
            <div className="luxury-detail__gallery">
                <div className="gallery-main">
                    <img
                        src={upgradeImageUrl(property.images?.[currentImageIndex]?.image_url) || 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1600&h=1000&fit=crop&q=90'}
                        alt={property.title}
                    />
                    ...
                    <div className="luxury-detail__section luxury-detail__header">
                        ...
                        {onStartTour && (
                            <button 
                                ...
                                onClick={() => onStartTour(propertyId, {
                                    id: propertyId,
                    ...
                    <div className="luxury-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            <div className="modal-property-preview">
                                <img src={upgradeImageUrl(property.images?.[0]?.image_url) || ''} alt={property.title} />
                                <div>
