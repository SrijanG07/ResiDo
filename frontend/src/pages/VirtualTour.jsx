...
const PANORAMA_POOL = {
    ...
    panoramic_living2: '/panoramas/shot-panoramic-composition-living-room%20(1).jpg',
    panoramic_living3: '/panoramas/shot-panoramic-composition-living-room%20(2).jpg',
    panoramic_living4: '/panoramas/shot-panoramic-composition-living-room%20(3).jpg',
    panoramic_living5: '/panoramas/shot-panoramic-composition-living-room%20(4).jpg',
    // WhatsApp Images
    whatsapp_room1: '/panoramas/WhatsApp%20Image%202026-01-30%20at%207.22.28%20PM.jpeg',
    whatsapp_room2: '/panoramas/WhatsApp%20Image%202026-01-30%20at%207.22.29%20PM.jpeg',
};

// Room templates with descriptions - 27 unique rooms
const ROOM_TEMPLATES = [
    { id: 'living', name: 'Living Room', key: 'living_room', description: 'Bright and airy living space with natural sunlight' },
    { id: 'lounge', name: 'Lounge', key: 'lounge', description: 'Cozy lounge area with warm ambiance' },
    { id: 'kitchen', name: 'Kitchen & Dining', key: 'kitchen', description: 'Open-plan kitchen with rustic charm' },
    { id: 'master-bedroom', name: 'Master Bedroom', key: 'master_bedroom', description: 'Spacious master suite with ensuite access' },
    { id: 'bedroom', name: 'Guest Bedroom', key: 'bedroom', description: 'Modern guest room with scenic views' },
    { id: 'study', name: 'Study Room', key: 'study_room', description: 'Elegant reading room with classic architecture' },
    { id: 'room1', name: 'Den', key: 'room1', description: 'Private den for relaxation and entertainment' },
    { id: 'room2', name: 'Family Room', key: 'room2', description: 'Comfortable family gathering space' },
    { id: 'room3', name: 'Home Office', key: 'room3', description: 'Productive workspace with modern amenities' },
    { id: 'room4', name: 'Media Room', key: 'room4', description: 'Entertainment area with premium setup' },
    { id: 'room5', name: 'Guest Suite', key: 'room5', description: 'Welcoming space for overnight guests' },
    { id: 'anniversary', name: 'Anniversary Lounge', key: 'anniversary_lounge', description: 'Elegant celebration space with sophisticated decor' },
    { id: 'photostudio', name: 'Photography Studio', key: 'brown_photostudio', description: 'Professional studio with premium lighting' },
    { id: 'combination', name: 'Multi-Purpose Room', key: 'combination_room', description: 'Versatile space for various activities' },
    { id: 'lythwood', name: 'Lythwood Suite', key: 'lythwood_room', description: 'Classic British-style sitting room' },
    { id: 'studio1', name: 'Creative Studio', key: 'photo_studio', description: 'Bright creative workspace' },
    { id: 'studio2', name: 'Art Studio', key: 'poly_haven_studio', description: 'Inspiring space for artistic pursuits' },
    { id: 'empty1', name: 'Bonus Room', key: 'small_empty_room1', description: 'Flexible empty space ready for customization' },
    { id: 'empty2', name: 'Storage Room', key: 'small_empty_room2', description: 'Additional storage and utility space' },
    { id: 'panoramic1', name: 'Grand Living', key: 'panoramic_living1', description: 'Expansive living area with panoramic views' },
    { id: 'panoramic2', name: 'Modern Lounge', key: 'panoramic_living2', description: 'Contemporary lounge with sleek design' },
    { id: 'panoramic3', name: 'Luxury Sitting', key: 'panoramic_living3', description: 'Upscale sitting area with premium finishes' },
    { id: 'panoramic4', name: 'Designer Living', key: 'panoramic_living4', description: 'Architect-designed living space' },
    { id: 'panoramic5', name: 'Premium Hall', key: 'panoramic_living5', description: 'Grand hall with elegant furnishings' },
    { id: 'whatsapp1', name: 'Sunlit Room', key: 'whatsapp_room1', description: 'Bright room with natural sunlight' },
    { id: 'whatsapp2', name: 'Cozy Corner', key: 'whatsapp_room2', description: 'Intimate corner perfect for relaxation' },
];
        ...
        return (
            <div className="virtual-tour-intro">
                ...
                <div className="featured-property">
                    ...
                    <h1>{property.title || `${property.bedrooms || 3}BHK ${property.type || 'Apartment'}`}</h1>
                    <p className="featured-location">{property.location || property.address || 'Premium Location'}</p>
                    ...
                    <div className="featured-stats">
                        <div className="stat"><span>{property.bedrooms || 3}</span>Bedrooms</div>
                        <div className="stat"><span>{property.bathrooms || 2}</span>Bathrooms</div>
                        <div className="stat"><span>{property.sqft || property.area || '1,500'}</span>Sq Ft</div>
                        <div className="stat"><span>{property.price || '₹85L'}</span></div>
                    </div>
        ...
        <div className="virtual-tour-main">
            ...
            <div className="tour-header">
                ...
                <div className="tour-info">
                    {property.title || `${property.bedrooms || 3}BHK`} - {property.location || 'Premium Location'}
                </div>
            </div>
